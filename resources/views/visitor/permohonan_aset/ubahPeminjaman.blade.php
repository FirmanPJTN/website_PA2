...
<div class="wrapper">
        ...
        <nav aria-label="breadcrumb" class="bg-light  mb-5">
            <ol class="breadcrumb mx-3 mt-2" style="color: RGBA(107,107,107,0.75)">
                ...
                <li class="breadcrumb-item" aria-current="page"><a href="{{route('visitor-peminjaman')}}">Peminjaman Aset</a></li>
                <li class="breadcrumb-item active fw-bold text-color" aria-current="page">Ubah Peminjaman Aset</li>
            </ol>
        </nav>

    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="d-flex mb-4">
                <a href="#" class="btn btn-primary mx-2" data-bs-toggle="modal" data-bs-target="#tambah-pengadaan">Tambah Pengadaan</a>
            </div>

            @include('layouts.modalTambahPengadaanVisitor')
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button class="btn btn-warning" disabled><span class="iconify" data-icon="mdi:progress-alert" data-height="20"></span> Diterima</button>
                                @endif
                                @if($ada->status == 'tolak')

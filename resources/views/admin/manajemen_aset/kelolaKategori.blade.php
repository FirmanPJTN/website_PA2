...
<body>
        ...
        <div id="content">
            ...
            <nav aria-label="breadcrumb" class="bg-light">
                <ol class="breadcrumb mx-3 mt-2" style="color: RGBA(107,107,107,0.75)">
                    ...
                    <li class="breadcrumb-item active fw-bold text-color" aria-current="page">Kelola Kategori</li>
                </ol>
            </nav>


            <h2 class="mb-3 mt-4 fw-bold mx-4 mb-5 mt-5">DAFTAR KATEGORI</h2>

            <div class="d-flex mt-4 ml-4 justify-content-start">

                <a href="#" class="btn btn-primary mx-2" data-bs-toggle="modal" data-bs-target="#tambahKategori">Tambah Kategori</a>

            </div>


            <!-- MODAL TAMBAH UNIT -->
            @include('layouts.modalTambahKategori')
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex">
                                    <a href="#" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#ubahKategori<?= $ktg->id ?>">Ubah</a> &nbsp;
                                    <a data-id="{{ $ktg->id }}" class="btn btn-danger deleteKategori" data-kode="{{$ktg -> id}}" href="#">Hapus</a>
                                </div>
                            </td>
                        </tr>
                        ...
                        <!-- MODAL UBAH UNIT -->
                        @include('layouts.modalUbahKategori')
    ...
    <script type="text/javascript" src="../../../js/scriptDeleteConfirmKategori.js"></script>

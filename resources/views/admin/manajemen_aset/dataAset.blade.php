        ...
        <div id="content">
            ...
            <div class="d-flex mt-4">
                ...
                <div class="d-flex justify-content-start mb-4">
                    <a href="/ManajemenAset/DataAset/Tambah" class="btn btn-success mx-2">Tambah Aset</a>
                    <a href="/ManajemenAset/DataAset/Gedung/" class="btn btn-primary mx-2">Kelola Gedung</a>
                    <a href="/ManajemenAset/DataAset/Kategori/" class="btn btn-primary mx-2">Kelola Kategori</a>
                </div>

                <div class="d-flex justify-content-end mb-4">
                    <a href="/ManajemenAset/DataAset/Export/" class="btn btn-secondary mx-2">Ekspor Data</a>
            ...
            <table class="table table-striped table-bordered mb-5">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$aset -> unit->nama}}</td>
                        <td class="text-center">
                            <div class="d-flex">
                                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#abc{{$i}}">Detail</a> &nbsp;
                                <a href="/ManajemenAset/DataAset/Ubah/{{$aset -> kodeAset}}" class="btn btn-warning">Ubah</a> &nbsp;
                                <a data-id="{{ $aset->kodeAset }}" class="btn btn-danger delete" data-kode="{{$aset -> kodeAset}}" href="#">Hapus</a>
                            </div>
                        </td>
                    </tr>

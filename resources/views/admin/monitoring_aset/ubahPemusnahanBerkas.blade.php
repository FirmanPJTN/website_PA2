...
<div class="wrapper">
        ...
        <div id="content">
            ...
            <ol class="breadcrumb mx-3 mt-2" style="color: RGBA(107,107,107,0.75)">
                ...
                <li class="breadcrumb-item"><a href="{{route('musnah-berkas')}}"><span class="iconify" data-icon="eos-icons:cluster-management" data-height="20"></span>&nbsp;&nbsp;&nbsp;&nbsp;Monitoring</a></li>
                <li class="breadcrumb-item" aria-current="page"><a href="{{route('musnah-berkas')}}">Pemusnahan Berkas</a></li>
                <li class="breadcrumb-item active fw-bold text-color" aria-current="page">Ubah Pemusnahan Berkas</li>
            </ol>
        </nav>
                ...
                <form enctype="multipart/form-data" action="/MonitoringAset/PemusnahanBerkas/Kirim/{{$pemusnahan->id}}" method="post">
                    ...
                    <div class="form-group mt-3">
                        <div class="d-flex justify-content-center">
                            ...
                            <textarea name="deskripsi" class="form-control mx-4" cols="30" rows="10" value="{{ $pemusnahan->deskripsi }}" autofocus autocomplete="off">{{ $pemusnahan->deskripsi }}</textarea>
                        </div>
                    </div>
                    @error('deskripsi')
                        <div class="alert-danger mt-1">{{$message}}</div>

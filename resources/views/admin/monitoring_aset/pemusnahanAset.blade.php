...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="d-flex justify-content-start mb-4">
                <a href="{{route('tambah-musnah-aset')}}" class="btn btn-primary mx-2">Tambah Pemusnahan</a>
            </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-around">
                                    ...
                                    &nbsp;
                                    <a href="/MonitoringAset/PemusnahanAset/Ubah/{{$musnah -> kodePemusnahan}}" class="btn btn-warning">Ubah</a>
                                    &nbsp;
                                    <a data-id="{{ $musnah->kodePemusnahan }}" class="btn btn-danger deleteAset" href="#">Hapus</a>
                                </div>
                            </td>
                        </tr>
            ...
            <h3 class="mb-5 mt-5 fw-bold">RIWAYAT PEMUSNAHAN ASET</h3>
    ...
    <script type="text/javascript" src="../../js/scriptDeleteConfirmPemusnahanAset.js"></script>

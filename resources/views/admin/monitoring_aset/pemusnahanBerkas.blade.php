...
<div class="wrapper">
        ...
        <nav aria-label="breadcrumb" class="bg-light  mb-5">
            <ol class="breadcrumb mx-3 mt-2" style="color: RGBA(107,107,107,0.75)">
                ...
                <li class="breadcrumb-item active fw-bold text-color" aria-current="page">Pemusnahan Berkas</li>
            </ol>
        </nav>


            <h2 class="mb-5 fw-bold text-center">DAFTAR PEMUSNAHAN BERKAS</h2>       
    ...
    <script type="text/javascript" src="../../js/scriptDeleteConfirmPemusnahanBerkas.js"></script>

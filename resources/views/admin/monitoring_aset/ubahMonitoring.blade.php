...
<div class="wrapper">
        ...
        <div id="content">
            ...
            <ol class="breadcrumb mx-3 mt-2" style="color: RGBA(107,107,107,0.75)">
                ...
                <li class="breadcrumb-item"><a href="{{route('perencanaan-monitoring')}}"><span class="iconify" data-icon="eos-icons:cluster-management" data-height="20"></span>&nbsp;&nbsp;&nbsp;&nbsp;Monitoring</a></li>

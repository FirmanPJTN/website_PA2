            ...
            <div class="modal-body row">
                ...
                <div class="form-group mt-3">
                    <div class="d-flex justify-content-center">
                        ...
                        <input type="text" name="tglAda" class="form-control mx-4" value="Eksternal (Barang Tidak Habis)" disabled autofocus autocomplete="off">
                        @else
                        <input type="text" name="tglAda" class="form-control mx-4" value="Internal (Barang Habis)" disabled autofocus autocomplete="off">
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group mt-3">
                    <div class="d-flex justify-content-center">
                        ...
                        <input type="text" name="tglAda" class="form-control mx-4" id="tglAda<?= $ada->id ?>" value="{{$ada -> created_at -> format('Y-m-d')}}" disabled>
                    </div>
                </div>
                ...
                <?php $pembelian = DB::table('pembelian')->where('id', $ada->pembelian_id)->get() ?>

<div class="modal fade" id="berkas<?= $musnah->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        @if($musnah -> gambar != NULL)
        <div class="form-group mt-3 ml-2">
            <div class="d-flex justify-content-between">
                <label class="mx-4 w-25">Bukti Otentik</label>
                <img src="../foto/pemusnahan-berkas/{{ $musnah -> gambar }}" class="mr-5"style="border: 1px black solid;"alt="" width="500">
                <img src="" class="mr-5" alt="" width="310" style="visibility: hidden">
            </div>
        </div>
        @endif

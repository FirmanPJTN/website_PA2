<div class="modal fade" id="tambahKategori" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        ...
        <form enctype="multipart/form-data" action="/ManajemenAset/DataAset/Kategori/Simpan" method="post">
                {{ csrf_field() }}
                <div class="modal-header">
                    <h2 class="modal-title fw-bold text-center" id="exampleModalLabel">TAMBAH KATEGORI</h2>
                ...
                <div class="modal-body row">
                    ...
                    <div class="form-group ml-2 mt-3">
                        <div class="d-flex justify-content-center">
                            ...
                            <input type="text" name="kategori" class="form-control mx-4" value="{{ old('kategori') }}" autofocus autocomplete="off">
                        </div>
                    </div>
                    @error('kategori')

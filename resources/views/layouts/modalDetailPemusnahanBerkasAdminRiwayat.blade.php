<div class="modal fade" id="berkasR<?= $i ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="form-group mt-3 ml-2">
            <div class="d-flex justify-content-start">
                ...
                <img src="../foto/pemusnahan-berkas/{{ $musnah -> bukti }}" style="border: 1px black solid;"alt="" width="300">
            </div>
        </div>
        @endif

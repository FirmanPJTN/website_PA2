    ...
    <div class="d-flex justify-content-end mr-3">
            ...
            <ul class="dropdown-menu dropdown-menu-right notify-menu mt-2" aria-labelledby="dropdownMenuLink">
                ...
                <li class="mt-3">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="/visitor/notifikasi/{{$ntfUser->id}}" class="delete-notifikasi" title="Telah dibaca"><span class="iconify sudahBaca" data-icon="emojione-v1:cross-mark" style="color: #f24e1e; margin-right: 10px; font-size: 14px"></span></a>
        ...
        <div class="dropdown mr-5">
            ...
            <ul class="dropdown-menu  mt-2" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href="/visitor/profil"><span class="iconify" data-icon="bx:user-pin" data-height="22"></span>&nbsp;Profil</a></li>

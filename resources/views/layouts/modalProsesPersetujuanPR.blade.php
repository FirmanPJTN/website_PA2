<div class="modal fade" id="def<?= $beli->id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <form enctype="multipart/form-data" action="/approver/Persetujuan/PegadaanAset/InternalPR/Simpan/{{$beli->id}}" method="post">
        ...
        <input type="text" name="statusSetujuPR" value="setuju-PR" style="visibility: hidden">
        ...
        <input type="text" name="deskripsiNotifTolakPR" value="PR kode pengadaan {{$ada->kodePengadaan}} ditolak" style="visibility: hidden">

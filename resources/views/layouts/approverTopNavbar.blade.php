<nav class="navbar navbar-light rounded-pill" style="background-color: #135589;">
    ...
    <div class="dropdown mr-2">
            <a href="#" class="mx-4 dropdown-toggle my-dropdown-toggle" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <?php $numNotif = DB::table('notifikasi')->where('role',Auth::user()->role)->count(); ?>
                @if($numNotif!=0)
            ...
            <ul class="dropdown-menu dropdown-menu-right notify-menu mt-2" aria-labelledby="dropdownMenuLink">
                ...
                @foreach($data as $ntf)
                    <li class="mt-3">
                        ...
                        <div class="d-flex">
                            ...
                            <a href="/approver/notifikasi/{{$ntf->id}}"  class="delete-notifikasi" title="Telah dibaca"><span class="iconify sudahBaca" data-icon="emojione-v1:cross-mark" style="color: #f24e1e; margin-right: 10px; font-size: 14px"></span></a>
                ...
                <li class="text-center mt-2">
                    <a href="/approver/notifikasiRole/{{Auth::user()->role}}" style="color:#2a93d5;  text-decoration: underline;">tandai semua telah dibaca</a>
                </li>
            </ul>
        </div>
        ...
        <div class="dropdown mr-5">
            ...
            <ul class="dropdown-menu  mt-2" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item" href="/approver/profil"><span class="iconify" data-icon="bx:user-pin" data-height="22"></span>&nbsp;Profil</a></li>
